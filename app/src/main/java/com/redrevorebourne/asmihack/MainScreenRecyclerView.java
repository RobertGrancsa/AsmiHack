...
//    private MainScreenRecyclerView.AudioAdapter mCompanyAdapter;
//
//    public void setConfig(RecyclerView recyclerView, Context context, List<Module> audio){
//        mContext = context;
//        mCompanyAdapter = new MainScreenRecyclerView.AudioAdapter(audio);
//        mCompanyAdapter.setHasStableIds(true);
//        recyclerView.setLayoutManager(new LinearLayoutManager(context));
//        recyclerView.setAdapter(new MainScreenRecyclerView.AudioAdapter(audio));
